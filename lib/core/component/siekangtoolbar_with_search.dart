...
const toolbarWithSearchKey = GlobalObjectKey<_SiEkangToolbarWithSearchState>(1);

class SiEkangToolbarWithSearch extends StatefulWidget {
  ...
  // Constructor
  SiEkangToolbarWithSearch({required this.onTextChanged, this.title})
      : super(key: toolbarWithSearchKey) {
    if (kDebugMode) log('onTextChanged : $onTextChanged');
  }

  @override
  State<SiEkangToolbarWithSearch> createState() =>
      _SiEkangToolbarWithSearchState();
}

class _SiEkangToolbarWithSearchState extends State<SiEkangToolbarWithSearch> {
